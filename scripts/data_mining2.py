class data():
    ...
    def reformat_oxford(self):
        ...
        self.oxford["Shortcut"]=self.oxford["CountryCode"]
        self.oxford=self.oxford[["Shortcut","Date","StringencyIndex"]]
    ...
    def merge_whole_dataset(self):
        ...
        traindata=traindata.merge(self.oxford,on=["Shortcut","Date"],how="left")
        return traindata
